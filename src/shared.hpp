...
std::expected<std::string, error_trail> resolve_require_path(lua_State* L, string name, span<const string> file_exts = default_file_extensions);
std::expected<std::string, error_trail> resolve_path(string name, const path& base, span<const string> file_exts = default_file_extensions);
